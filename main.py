...
def get_zodiac(day, month):
    zodiacs = [
        ((3, 21), (4, 19), "Hamal (Qo'y)"),
        ((4, 20), (5, 20), "Savr (Buzoq)"),
        ((5, 21), (6, 20), "Javzo (Egizaklar)"),
        ((6, 21), (7, 22), "Saraton (Qisqichbaqa)"),
        ((7, 23), (8, 22), "Asad (Arslon)"),
        ((8, 23), (9, 22), "Sunbula (Parizod/Boshoq)"),
        ((9, 23), (10, 22), "Mezon (Tarozi)"),
        ((10, 23), (11, 21), "Aqrab (Chayon)"),
        ((11, 22), (12, 21), "Qavs (O'qotar)"),
        ((12, 22), (1, 19), "Jadi (Tog' echkisi)"),
        ((1, 20), (2, 18), "Dalv (Qovg'a)"),
        ((2, 19), (3, 20), "Hut (Baliqlar)")
    ]
